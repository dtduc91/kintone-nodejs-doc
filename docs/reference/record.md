...
This module will provide functions of CURD, update the record status & assignees in the kintone app
...
let kintoneRecord = kintone.Record(connection);
```
...
| fields | Array<String\> | (optional) | The field codes that you want in the response.
| totalCount | Boolean | optional) | If set to "true", the request will retrieve the total count of records that were retrieved that match the query conditions.
...
| --- | --- | --- | --- |
| appID | Integer | yes | The kintone app ID
| recordData | JSONObject | yes | The record data that will being added to kintone app. See below sample code or [reference](#reference) at the end of this page to know format.
...
| --- | --- | --- | --- |
| appID | Integer | yes | The kintone app ID
| recordsData | Array<JSONObject\> | yes | The records data that will being added to kintone app. See below sample code or [reference](#reference) at the end of this page to know format.
...
| --- | --- | --- | --- |
| appID | Integer | yes | The kintone app ID
| updateKey | JSONObject | yes | The unique key of the record to be updated. See belowsample codee or [reference](#reference) at the end of this page to know format.
| recordData | JSONObject | yes | The record data that will being added to kintone app. See below sample code or [reference](#reference) at the end of this page to know format.
| revision | Integer | yes | The revision number of record
...
| --- | --- | --- | --- |
| appID | Integer | yes | The kintone app ID
| recordsData | Array<JSONObject\> | yes | The record data that will being added to kintone app. See below sample code or [reference](#reference) at the end of this page to know format.
...
| --- | --- | --- | --- |
| appID | Integer | yes | The kintone app ID
| recordIDs | Array<Integer\> | yes | The list ids of record that you want to delete.
...
| appID | Integer | yes | The kintone app ID
| recordID | Integer | yes | The record ID on kintone app
| actionName | String | yes | The Action name of the action you want to run
...
| order | String | (optional) | The sort order of the Comment ID. Either **asc** or **desc**
...
| appID | Integer | yes | The kintone app ID |
| recordID | Integer | yes | The kintone app ID |
| commentContent | JSONObject | yes | See below sample code or [reference](#reference) at the end of this page to know format.|
